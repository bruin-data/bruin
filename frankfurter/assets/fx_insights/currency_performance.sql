...
description: This query retrieves the exchange rates from frankfurter.daily_rates for all currencies and joins frankfurter.currency_names to each currency code for better readability. Finally, it presents the exchange rates for the current date and compares them with the rates from the previous day, 7 days ago and 30 days ago. 
