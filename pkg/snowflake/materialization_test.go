...
// 				"  WHERE  t1._valid_from < TRY_CAST(s1.ts AS TIMESTAMP) AND t1._is_current\n" +
// 				") AS source\n" +
// 				"ON  target.id = source.id AND target._is_current AND source._is_current\n" +
// 				"\n" +
// 				"WHEN MATCHED AND (\n" +
// 				"  target._valid_from < TRY_CAST(source.ts AS TIMESTAMP)\n" +
// 				") THEN\n" +
// 				"  UPDATE SET\n" +
// 				"    target._valid_until = TRY_CAST(source.ts AS TIMESTAMP),\n" +
...
// 				"  VALUES (source.id, source.event_name, source.ts, TRY_CAST(source.ts AS TIMESTAMP), TO_TIMESTAMP('9999-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), TRUE)",
// 		},
// 		{
...
// 				"  VALUES (source.id, source.event_type, source.col1, source.col2, source.ts, TRY_CAST(source.ts AS TIMESTAMP), TO_TIMESTAMP('9999-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), TRUE)",
// 		},
// 		{
...
// 				"SELECT\n" +
// 				"  src.*,\n" +
// 				"  TRY_CAST(ts AS TIMESTAMP) AS _valid_from,\n" +
...
// 				"  VALUES (source.id, source.col1, source.col2, source.col3, source.col4, CURRENT_TIMESTAMP(), TO_TIMESTAMP('9999-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), TRUE)",
// 		},
// 		{
...
// 				"  WHERE  t1.name != s1.name OR t1.price != s1.price\n" +
// 				") AS source\n" +
// 				"ON  target.id = source.id AND target.category = source.category AND target._is_current = source._is_current\n" +
// 				"\n" +
// 				"WHEN MATCHED AND (\n" +
...
// 				"  VALUES (source.id, source.category, source.name, source.price, CURRENT_TIMESTAMP(), TO_TIMESTAMP('9999-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), TRUE)",
// 		},
// 		{
