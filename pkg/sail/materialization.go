...
// quoteIdentifier quotes a possibly dotted identifier (schema.table) using
// backticks. Sail speaks Spark SQL, where backticks delimit identifiers and
// double quotes denote string literals, so backticks must be used here.
