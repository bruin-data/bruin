...
func TestMySQLConnectionReadOnlyRoundTrip(t *testing.T) {
	t.Parallel()
	for _, conn := range []any{&MySQLConnection{}} {
...
func TestMySQLConnectionReadOnlySchema(t *testing.T) {
	t.Parallel()
	...
	for _, name := range []string{"MySQLConnection"} {
