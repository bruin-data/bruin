...
func assertAssetExists(t *testing.T, afterPipeline *Pipeline, asset *Asset) {
	...
	for _, gotCol := range assetFound.Columns {
		...
		// Compare upstream data if present
		if (gotCol.Upstreams == nil) != (wantCol.Upstreams == nil) {
			...
			if gotCol.Upstreams.Asset != wantCol.Upstreams.Asset ||
				gotCol.Upstreams.Column != wantCol.Upstreams.Column ||
				gotCol.Upstreams.Table != wantCol.Upstreams.Table {
				t.Errorf("Column %s.%s upstream mismatch: got %+v, want %+v",
					asset.Name, gotCol.Name, gotCol.Upstreams, wantCol.Upstreams)
			}
		}
	}
}
				...
				Assets: []*Asset{
					{
						...
						Columns: []Column{
							...
							{Name: "upper_name", Type: "str", Upstreams: &UpstreamColumn{Asset: "source_table", Column: "name", Table: "source_table"}, UpdateOnMerge: false, Description: "User name", Checks: []ColumnCheck{}},
							{Name: "doubled_age", Type: "int64", Upstreams: &UpstreamColumn{Asset: "source_table", Column: "age", Table: "source_table"}, UpdateOnMerge: false, Description: "User age", Checks: []ColumnCheck{}},
						},
						Upstreams: []Upstream{{Value: "source_table"}},
					},
					{
				...
				Assets: []*Asset{
					{
						...
						Columns: []Column{
							...
							{Name: "full_name", Type: "str", Upstreams: &UpstreamColumn{Asset: "source_table", Column: "full_name", Table: "source_table"}},
						},
						Upstreams: []Upstream{{Value: "source_table"}},
					},
					{
				...
				Assets: []*Asset{
					{
						...
						Type: "bq.sql",
						Columns: []Column{
							{Name: "order_id", Type: "int64", Upstreams: &UpstreamColumn{Asset: "orders", Column: "order_id", Table: "orders"}},
							{Name: "customer_name", Type: "str", Upstreams: &UpstreamColumn{Asset: "customers", Column: "customer_name", Table: "customers"}},
							{Name: "product_name", Type: "str", Upstreams: &UpstreamColumn{Asset: "products", Column: "product_name", Table: "products"}},
							{Name: "total_amount", Type: "float64", Upstreams: &UpstreamColumn{Asset: "orders,products", Column: "quantity,price", Table: "orders,products"}},
							{Name: "status_description", Type: "str", Upstreams: &UpstreamColumn{Asset: "order_status", Column: "status_description", Table: "order_status"}},
						},
						Upstreams: []Upstream{
							{Value: "orders"},
							{Value: "customers"},
					...
					},
					{
						...
						Type: "bq.sql",
						Columns: []Column{
							{Name: "order_id", Type: "int64", Upstreams: &UpstreamColumn{Asset: "raw_orders", Column: "order_id", Table: "raw_orders"}},
							{Name: "customer_id", Type: "int64", Upstreams: &UpstreamColumn{Asset: "raw_orders", Column: "customer_id", Table: "raw_orders"}},
							{Name: "product_id", Type: "int64", Upstreams: &UpstreamColumn{Asset: "raw_orders", Column: "product_id", Table: "raw_orders"}},
							{Name: "quantity", Type: "int64", Upstreams: &UpstreamColumn{Asset: "raw_orders", Column: "quantity", Table: "raw_orders"}},
							{Name: "status_id", Type: "int64", Upstreams: &UpstreamColumn{Asset: "raw_orders", Column: "status_id", Table: "raw_orders"}},
						},
						Upstreams: []Upstream{{Value: "raw_orders"}},
					},
					{
