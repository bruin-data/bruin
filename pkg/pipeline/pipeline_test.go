...
func Test_pipelineBuilder_CreatePipelineFromPath(t *testing.T) {
		...
		Upstreams: []pipeline.Upstream{
			{
				...
				Mode:    pipeline.UpstreamModeFull.String(),
			},
		},
	...
	asset3 := &pipeline.Asset{
		...
		Secrets:    []pipeline.SecretMapping{},
		Upstreams: []pipeline.Upstream{
			{Type: "asset", Value: "task1", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
			{Type: "asset", Value: "task2", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
			{Type: "asset", Value: "task3", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
			{Type: "asset", Value: "task4", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
			{Type: "asset", Value: "task5", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
			{Type: "asset", Value: "task3", Columns: make([]pipeline.DependsColumn, 0), Mode: pipeline.UpstreamModeFull.String()},
		},
		Columns:      make([]pipeline.Column, 0),
		CustomChecks: make([]pipeline.CustomCheck, 0),
