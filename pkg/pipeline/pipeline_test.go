...
func TestIntervalModifiers_ModifyDate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "add 3 hours",
			modifiers: pipeline.IntervalModifiers{Start: "3h"},
		...
		{
			name:      "add 15 minutes",
			modifiers: pipeline.IntervalModifiers{Start: "15m"},
			baseTime:  "2023-07-01 10:00:00.000000",
		...
		{
			name:      "add 30 seconds",
			modifiers: pipeline.IntervalModifiers{Start: "30s"},
			baseTime:  "2023-07-01 10:00:00.000000",
		...
		{
			name:      "add 2 months",
			modifiers: pipeline.IntervalModifiers{Start: "2M"},
			baseTime:  "2023-07-01 10:00:00.000000",
		...
		},
		{
			...
			modifiers: pipeline.IntervalModifiers{Start: "-10s"},
			baseTime:  "2023-07-01 10:00:00.000000",
		...
		{
			name:       "invalid suffix",
			modifiers:  pipeline.IntervalModifiers{Start: "10x"},
			baseTime:   "2023-07-01 10:00:00.000000",
			wantTime:   time.Date(2023, 7, 1, 10, 0, 0, 0, time.UTC),
			wantErr:    true,
			errMessage: "unknown interval suffix 'x' in \"10x\"; must be h, m, s, or M",
		},
		{
			name:       "non-numeric value",
			modifiers:  pipeline.IntervalModifiers{Start: "abc"},
			baseTime:   "2023-07-01 10:00:00.000000",
			wantTime:   time.Date(2023, 7, 1, 10, 0, 0, 0, time.UTC),
			wantErr:    true,
			errMessage: "invalid numeric portion \"ab\" in interval \"abc\": strconv.Atoi: parsing \"ab\": invalid syntax",
		},
		{
			name:       "empty or invalid length",
			modifiers:  pipeline.IntervalModifiers{Start: "a"},
			baseTime:   "2023-07-01 10:00:00.000000",
			wantTime:   time.Date(2023, 7, 1, 10, 0, 0, 0, time.UTC),
			wantErr:    true,
			errMessage: "must contain a number + suffix",
		},
		{
			name:      "date only format - add 1 day",
			modifiers: pipeline.IntervalModifiers{Start: "24h"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 7, 2, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - subtract 2 days",
			modifiers: pipeline.IntervalModifiers{Start: "-48h"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 6, 29, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - add 1 month",
			modifiers: pipeline.IntervalModifiers{Start: "1M"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 8, 1, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},

		{
			name:      "date only format - year rollover",
			modifiers: pipeline.IntervalModifiers{Start: "6M"},
			baseTime:  "2023-12-01",
			wantTime:  time.Date(2024, 6, 1, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - add days using d",
			modifiers: pipeline.IntervalModifiers{Start: "3d"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 7, 4, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - subtract days using d",
			modifiers: pipeline.IntervalModifiers{Start: "-5d"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 6, 26, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - month transition using d",
			modifiers: pipeline.IntervalModifiers{Start: "35d"},
			baseTime:  "2023-07-01",
			wantTime:  time.Date(2023, 8, 5, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "date only format - year transition using d",
			modifiers: pipeline.IntervalModifiers{Start: "-5d"},
			baseTime:  "2024-01-01",
			wantTime:  time.Date(2023, 12, 27, 0, 0, 0, 0, time.UTC),
			wantErr:   false,
		},
		{
			name:      "microsecond format - add hours",
			modifiers: pipeline.IntervalModifiers{Start: "3h"},
			baseTime:  "2023-07-01T10:30:45.123456",
			wantTime:  time.Date(2023, 7, 1, 13, 30, 45, 123456000, time.UTC),
			wantErr:   false,
		},
		{
			name:      "microsecond format - subtract minutes",
			modifiers: pipeline.IntervalModifiers{Start: "-90m"},
			baseTime:  "2023-07-01T10:30:45.123456",
			wantTime:  time.Date(2023, 7, 1, 9, 0, 45, 123456000, time.UTC),
			wantErr:   false,
		},
		{
			name:      "microsecond format - day transition",
			modifiers: pipeline.IntervalModifiers{Start: "15h"},
			baseTime:  "2023-07-01T20:30:45.123456",
			wantTime:  time.Date(2023, 7, 2, 11, 30, 45, 123456000, time.UTC),
			wantErr:   false,
		},
		{
			name:      "microsecond format - month transition with seconds",
			modifiers: pipeline.IntervalModifiers{Start: "720h"},
			baseTime:  "2023-07-31T23:59:59.999999",
			wantTime:  time.Date(2023, 8, 30, 23, 59, 59, 999999000, time.UTC),
			wantErr:   false,
		},
		...
		},
		{
			...
			modifiers: pipeline.IntervalModifiers{Start: "45m"},
		...
		},
		{
			...
			modifiers: pipeline.IntervalModifiers{Start: "-75m"},
		...
		},
		{
			...
			modifiers: pipeline.IntervalModifiers{Start: "180m"},
		...
		},
		{
			...
			modifiers: pipeline.IntervalModifiers{Start: "12h"},
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			t.Parallel()
			time, err := date.ParseTime(tt.baseTime)
			if err != nil {
				t.Fatalf("failed to parse base time: %v", err)
			}
			gotTime, err := tt.modifiers.ModifyDate(time)
