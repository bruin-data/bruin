...
<img src="/public/dev-env/demo.png" alt="Developer Environment IDE interface showing integrated pipeline authoring and deployment tools">
...
- Scroll down to `Developer Environment Secret`. <img style="padding: 1rem 0" src="/public/dev-env/environment-secret.png" alt="Developer Environment Secret section in Team Settings with text field for .bruin.yml configuration">
