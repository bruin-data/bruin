...
## Writing data to S3
Bruin also allows you to move data from your data warehouse to S3 using Ingestr assets. This is useful for exporting processed data, creating backups, or sharing data.
...
:::info NOTE
`endpoint_url` is currently only available when S3 is used as a destination. Support for reading data from S3-Compatiable storage is coming soon!
:::
