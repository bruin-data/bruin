...
- `source_table`: the bucket name and file path (or [file glob](https://getbruin.com/docs/ingestr/supported-sources/gcs.html#file-pattern)) separated by a forward slash (`/`).
