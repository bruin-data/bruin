...
| `version` | No | Selects the version of ingestr to install and use. | Use this to control what version of ingestr you would like to use. Valid options are `v1` (latest), `v0` (legacy) or `v1.x.y` (full version specifer) | 
