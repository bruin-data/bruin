    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Glossary", link: "/getting-started/glossary" },
          {
            ...
            collapsed: true,
            items: [
              { text: "shopify-bigquery", link: path.resolve(__dirname, '../../templates/shopify-bigquery/README.md') },
              { text: "athena", link: path.resolve(__dirname, '../../templates/athena/README.md') },
              { text: "notion", link: path.resolve(__dirname, '../../templates/notion/README.md') },
              { text: "chess", link: path.resolve(__dirname, '../../templates/chess/README.md') },
              { text: "duckdb", link: path.resolve(__dirname, '../../templates/duckdb/README.md') },
              { text: "gorgias", link: path.resolve(__dirname, '../../templates/gorgias/README.md') },
              { text: "firebase", link: path.resolve(__dirname, '../../templates/firebase/README.md') },
              { text: "gsheet-bigquery", link: path.resolve(__dirname, '../../templates/gsheet-bigquery/README.md') },
              { text: "gsheet-duckdb", link: path.resolve(__dirname, '../../templates/gsheet-duckdb/README.md') },
              { text: "python", link: path.resolve(__dirname, '../../templates/python/README.md') },
              { text: "shopify-duckdb", link: path.resolve(__dirname, '../../templates/shopify-duckdb/README.md') },
            ],
          },
