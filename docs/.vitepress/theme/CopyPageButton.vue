...
// Get the current page's markdown URL from GitHub raw content
const markdownUrl = computed(() => {
  const relativePath = page.value.relativePath
  return `https://raw.githubusercontent.com/bruin-data/bruin/main/docs/${relativePath}`
})

// Pre-fetch markdown when page loads or changes for instant copy
...
async function getPageMarkdown() {
  ...
  // Fallback: convert current page HTML to markdown
...
// HTML to Markdown converter (fallback if fetch fails)
