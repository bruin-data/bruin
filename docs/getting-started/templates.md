...
<div class="template-grid">
  ...
  <a class="template-card" href="./templates-docs/google-web-analytics-README.html">
    <span class="template-card__category">Organic search analytics</span>
    <strong>google-web-analytics</strong>
    <span>Turns GA4 and Search Console exports already in BigQuery into staging models plus nine reports neither product can produce, including the landing-page join between search visibility and post-click outcomes.</span>
  ...
  <a class="template-card" href="./templates-docs/demo-self-heal-pipeline-README.html">
    <span class="template-card__category">Agent test pipeline</span>
    <strong>demo-self-heal-pipeline</strong>
  ...
  <a class="template-card" href="./templates-docs/demo-payments-clickhouse-README.html">
    <span class="template-card__category">Near-real-time demo</span>
    <strong>demo-payments-clickhouse</strong>
...
<div class="template-grid">
  ...
  <a class="template-card" href="./templates-docs/posthog-bigquery-README.html">
    ...
    <span>Models PostHog events, persons, and feature flags into BigQuery, then builds account-level engagement, product-qualified-account, feature-adoption, and retention reports with a DAC dashboard.</span>
    <span class="template-card__tags"><code>PostHog</code><code>BigQuery</code><code>DAC</code></span>
  </a>
