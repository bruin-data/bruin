...
func TestIndividualTasks(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			task: e2e.Task{
				...
				Args: []string{
					...
					"--asset", filepath.Join(currentFolder, "test-pipelines/semantic-query-pipeline/assets/anchor.sql"),
				...
				Env:           []string{},
				SkipJSONNodes: []string{`"query"`},
				Expected: e2e.Output{
					ExitCode: 0,
					Output:   helpers.ReadFile(filepath.Join(currentFolder, "test-pipelines/semantic-query-pipeline/expectations/expected-cli-flags.json")),
				},
				Asserts: []func(*e2e.Task) error{
					e2e.AssertByExitCode,
					e2e.AssertByOutputJSON,
		...
		{
			name: "query-semantic-window-metric",
			task: e2e.Task{
				Name:    "query-semantic-window-metric",
				Command: binary,
				Args: []string{
				...
				Expected: e2e.Output{
					ExitCode: 0,
					Output:   helpers.ReadFile(filepath.Join(currentFolder, "test-pipelines/semantic-query-pipeline/expectations/expected-window.json")),
				},
				Asserts: []func(*e2e.Task) error{
					e2e.AssertByExitCode,
					e2e.AssertByOutputJSON,
		...
		{
			name: "query-semantic-pipeline-connection",
			task: e2e.Task{
				Name:    "query-semantic-pipeline-connection",
				Command: binary,
				Args: []string{
		...
		},
		{
			...
			task: e2e.Task{
				...
				Expected: e2e.Output{
					ExitCode: 1,
					Output:   helpers.ReadFile(filepath.Join(currentFolder, "test-pipelines/semantic-query-pipeline/expectations/expected-unknown-metric.json")),
				},
				Asserts: []func(*e2e.Task) error{
					e2e.AssertByExitCode,
					e2e.AssertByOutputJSON,
