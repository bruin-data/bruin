...
-- Los Angeles closed on 2026-01-31, after the last order in the data, so no order
...
SELECT * FROM (
    VALUES
        ...
        (6, 'LAX01', 'US', 'United States', 'Los Angeles', DATE '2018-09-01', DATE '2026-01-31', 'closed', 'America/Los_Angeles')
