...
FROM (VALUES
    ...
    ( 2, DATE '2026-05-15', 'council clerk',            'Says the riverside rezoning was the most contested item of the spring. It had been brought forward twice before and pulled both times.'),
    ...
    ( 5, DATE '2026-05-16', 'building manager',         'The Corvid Building is let to eleven tenants. Cleaning and maintenance are contracted out, not employed directly.'),
    ...
    (10, DATE '2026-05-18', 'range secretary',          'The club has around sixteen hundred members. Most shoot short lanes at the two town ranges. Only the Marlpit site has butts beyond three hundred metres.'),
    ...
    (14, DATE '2026-05-19', 'firearms licensing',       'Holding a certificate for that chambering is entirely ordinary in Ashmont. It tells you almost nothing on its own.'),
    ...
    (18, DATE '2026-05-20', 'network operator',         'The Corvid Building has an operator microcell on its own roof serving the north block. It is a separate site from the one covering the square.'),
    ...
    (22, DATE '2026-05-21', 'land registry',            'The riverside parcels are held by a company rather than an individual. The filing names a principal.'),
